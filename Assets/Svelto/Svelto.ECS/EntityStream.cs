...
{
    // todo: ASK. isn't this being used as a normal polling mechanism in the example? Specially so in sequenced engines.
    // todo: ASK. What is this capacity, how to choose one?
    /// <summary>
